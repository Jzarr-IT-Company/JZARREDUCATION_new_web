                ...
                <div className="col-md-6 col-12 order-1 order-md-2">
                    <div style={{ padding: "56.25% 0 0 0", position: "relative" }}>
                        <iframe
                            width="560"
                            height="315"
                            src="https://www.youtube.com/embed/iAcqNQIqGY4?si=s4Cf8zT76sJfUzIN"
                        ...
                        />
                        <a
                            href="https://www.youtube.com/watch?v=iAcqNQIqGY4"
                            target="_blank"
                ...
                <div className="col-md-6 col-12 order-2 order-md-1 d-flex align-items-center justify-content-center">
                    ...
                    >
                        <p className="display-5 fw-bold my-5" style={{marginBottom: '2rem', textAlign: 'center'}}>
                            E-commerce with AI.<br/>
                            Enroll before <span style={{color:'#1976d2'}}>15 Feb 2026</span> – <span style={{color:'#d32f2f'}}>Limited Seats</span>
                        </p>
                        <div style={{width: '100%'}}>
                            <BuyAllCoursesButton />
                        </div>
